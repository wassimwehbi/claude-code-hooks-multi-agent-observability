...
def main():
    ...
    parser.add_argument('--source-app', default=None, help='Source application name (auto-detects from project dir if omitted)')
    ...
    # Auto-detect source app from project directory if not provided
